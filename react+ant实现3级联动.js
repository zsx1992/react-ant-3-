// 使用 ant design Cascader
const address = {
    '北京': {
        '北京': ['东城区', '西城区', '崇文区', '宣武区', '朝阳区', '丰台区', '石景山区', '海淀区', '门头沟区', '房山区', '通州区', '顺义区', '昌平区', '大兴区', '平谷区', '怀柔区', '密云县', '延庆县', '其他']
    },
    '天津': {
        '天津': ['和平区', '河东区', '河西区', '南开区', '河北区', '红挢区', '滨海新区', '东丽区', '西青区', '津南区', '北辰区', '宁河区', '武清区', '静海县', '蓟县', '塘沽区', '汉沽区', '大港区', '宝坻区', '其他']
    },
    '河北': {
    ...
    '上海': {
        '上海': ['黄浦区', '卢湾区', '徐汇区', '长宁区', '静安区', '普陀区', '闸北区', '虹口区', '杨浦区', '闵行区', '宝山区', '嘉定区', '浦东新区', '金山区', '松江区',  '青浦区', '奉贤区', '崇明县', '其他']
    },
    '江苏': {
    ...
    const city = [];
      for (let j in address[key]){
          ...
          for (let k in address[key][j]){
            const obj = {
              'value':address[key][j][k],
              'label':address[key][j][k],
            }
            area.push(obj)
          }
        const obj1 = {
...
// 3.
<Cascader options={addressData}/> //结束